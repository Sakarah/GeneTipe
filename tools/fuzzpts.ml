let () =
    ...
    [
        ...
        ("-x", Arg.Set_float x_fuzz, "Shorthand for --x-fuzz");
        ("--y-fuzz", Arg.Set_float y_fuzz, "Set how far the ordinates can get from the original point (default is 0.1)");
        ("-y", Arg.Set_float y_fuzz, "Shorthand for --y-fuzz");
