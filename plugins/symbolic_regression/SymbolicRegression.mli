...
module Creation : Plugin.HookingPoint with type t = (Yojson.Basic.json -> PointSet.t -> pop_frac:float -> FunctionDna.t)
module Mutation : Plugin.HookingPoint with type t = (Yojson.Basic.json -> PointSet.t -> FunctionDna.t -> FunctionDna.t)
module Crossover : Plugin.HookingPoint with type t = (Yojson.Basic.json -> FunctionDna.t -> FunctionDna.t -> FunctionDna.t)
module Fitness : Plugin.HookingPoint with type t = (Yojson.Basic.json -> PointSet.t -> FunctionDna.t -> float)
