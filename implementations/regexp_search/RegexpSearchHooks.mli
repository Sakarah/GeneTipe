...
module Fitness : Plugin.HookingPoint with type t = (Yojson.Basic.json -> (module EvolParams.Fitness with type individual = RegexpTree.t and type target_data = ExampleList.t))
